...
-- insert into card (deck_name, question, answer, user_id) values ('life_decker','what is car?', 'vroom?', 2);
-- insert into card (deck_name, question, answer, user_id) values ('life_decker','what is life?', 'idk?', 1);
-- insert into card (deck_name, question, answer, user_id) values ('life_decker','what is money', 'cash?', 1);
-- insert into card (deck_name, question, answer, user_id) values ('life_decks','what is boat?', 'hoes?', 1);
-- insert into card (deck_name, question, answer, user_id) values ('life_decks','what is house?', 'stability?', 1);
